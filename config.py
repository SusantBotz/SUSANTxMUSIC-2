...
PRIVACY_LINK = getenv("PRIVACY_LINK", "https://github.com/SusantBotz/SUSANTxMUSIC")
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/SusantBotz/SUSANTxMUSIC",
)
...
START_IMG_URL = getenv(
    "START_IMG_URL", "https://files.catbox.moe/zspbkq.jpg"
)
PING_IMG_URL = getenv(
